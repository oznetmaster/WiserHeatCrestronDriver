...
The separately selected [Android control project](WiserHeatCrestronDriver.AndroidControlTests/README.md) adds a real Auto/Manual/Auto room-mode cycle with independent hub observation and restoration. Existing manual and scheduled targets may differ; both are retained. This can briefly change heating demand. It requires explicit private control-room bindings, and its live UI validation remains pending. Both Android projects skip during ordinary desktop runs without an active processor workflow.
