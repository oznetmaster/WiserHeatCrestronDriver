...
This .NET 10 test container integrates the processor workflow with Visual Studio Test Explorer and VSTest. The workflow and Android integration use **CrestronHomeNUnit.TestAdapter 1.8.1** from NuGet. The existing NUnit test projects and net472 processor package remain separate.
