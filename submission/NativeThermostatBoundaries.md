...
Run both cases in each supported unit configuration and retain the configuration's own restoration evidence. The cases observe the current units and refuse a unit change during a cycle; they do not change the driver configuration themselves. They establish neither outward-button behavior at a limit, gauge calibration/current-temperature feedback, paired-instance isolation nor official acceptance of unexecuted variants.
