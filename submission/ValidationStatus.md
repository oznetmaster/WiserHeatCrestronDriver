...
| Native thermostat controls | Celsius setpoint changes and Off/resume passed with restoration. Earlier candidate-specific Celsius/Fahrenheit, editor and save evidence remains retained with its original scope. Interior steps do not establish endpoint behavior. |
