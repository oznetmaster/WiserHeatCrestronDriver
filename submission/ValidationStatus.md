...
1. Finish candidate-bound control and rendered-UI coverage: reconcile the failed Celsius observation, exercise manual starting states, Off/resume behavior, physical bounds, editor actions, save conflicts, repeated/busy/error behavior and conditional configurations. Verify labels/icons/layout and meaningful physical feedback, including the thermostat gauge; text assertions alone do not prove its calibration.
